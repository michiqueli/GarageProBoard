...
ALTER TABLE "work_order" ADD CONSTRAINT "work_order_finished_by_id_app_user_id_fk" FOREIGN KEY ("finished_by_id") REFERENCES "public"."app_user"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "work_order" ADD CONSTRAINT "work_order_closed_by_id_app_user_id_fk" FOREIGN KEY ("closed_by_id") REFERENCES "public"."app_user"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "work_order_hold" ADD CONSTRAINT "work_order_hold_resolved_by_id_app_user_id_fk" FOREIGN KEY ("resolved_by_id") REFERENCES "public"."app_user"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
